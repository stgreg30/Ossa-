...
class Amygdala:
    """Simple tone analyzer that shifts mood between collaborative, defensive, analytical."""
    ...
    def analyze_tone(self, text: str):
        ...
        if col_score >= def_score and col_score >= ana_score and col_score > 0:
            ...
            # Default shift toward neutral collaboration
            mood = "collaborative"
            intensity = 0.5
        ...
        current["intensity"] = (current.get("intensity", 0.5) + intensity) / 2  # smooth
